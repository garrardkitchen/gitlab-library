...
/// <summary>MCP tools that wrap <see cref="Garrard.GitLab.FileOperations"/>.</summary>
[McpServerToolType]
public static class FileTools
{
    [McpServerTool(Name = "file_remove_temp_folder"), Description("Deletes a temporary folder and all its contents.")]
    public static string RemoveTempFolder(
    ...
    public static string CreateFileWithContent(
    ...
    public static async Task<string> ReplacePlaceholderInFile(
